...
 **/public class Rxxpadapter extends RecyclerView.Adapter<Rxxpadapter.OnewAdapter> {
    List<HomeBean.ResultBean.RxxpBean.CommodityListBean> list;
    Context context;

    public Rxxpadapter(List<HomeBean.ResultBean.RxxpBean.CommodityListBean> list, Context context) {
        this.list = list;
