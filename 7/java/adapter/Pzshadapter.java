...
 **/public class Pzshadapter extends RecyclerView.Adapter<Pzshadapter.OnewAdapter> {
    List<HomeBean.ResultBean.PzshBean.CommodityListBeanX> list;
    Context context;

    public Pzshadapter(List<HomeBean.ResultBean.PzshBean.CommodityListBeanX> list, Context context) {
        this.list = list;
    ...
    public OnewAdapter onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view= LayoutInflater.from(context).inflate(R.layout.pzsh_z_page,null);
