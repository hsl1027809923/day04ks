...
 *@Time:9:03
 *@Description:${适配器}
 **/public class Shoppingcart_Adapter extends BaseExpandableListAdapter {

    List<Beanl.OrderDataBean> list;
    Context context;

    public Shoppingcart_Adapter(List<Beanl.OrderDataBean> list, Context context) {
        this.list = list;
...
//        });
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        final String productName = list.get(groupPosition).getCartlist().get(childPosition).getProductName();
        final String shopname = list.get(groupPosition).getCartlist().get(childPosition).getShopName();
        //点击添加
        er.zbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EventBus.getDefault().post(productName);
